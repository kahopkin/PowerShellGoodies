...
var functionSubnetName = '/subnets/snet-function-${DeployObject.SolutionName}'
...
var hostnamesslstate_default  = '${SolutionObj.functionAppName}.${DeployObject.WebDomain}'
var hostnamesslstate_scm  = '${SolutionObj.functionAppName}.scm.${DeployObject.WebDomain}'
...
resource functionApp_HostNameBinding 'Microsoft.Web/sites/hostNameBindings@2021-03-01' = {
	parent: functionApp
	//name: '${SolutionObj.FunctionAppName}.azurewebsites.us'
	name: hostnamesslstate_default
	properties: {
...
//var functionSubnetName = 'snet-function-${DeployObject.SolutionName}'
//var functionSubnetName = '/subnets/snet-function-${DeployObject.SolutionName}'
...
/*
var sqlServerName ='sql-${DeployObject.SolutionName}'
...
resource sqlDatabase 'Microsoft.Sql/servers/databases@2020-11-01-preview' existing = if(Solution == 'Transfer') {
	name: 'sqldb-${DeployObject.SolutionName}'
}
//*/
...
resource apiLogAnalyticsWorkspace 'Microsoft.OperationalInsights/workspaces@2020-03-01-preview' existing = {
	name: 'log-${DeployObject.SolutionName}'  
}
//*/

//var contentShare  = split(DeployObject.SolutionName,'-')[0]
