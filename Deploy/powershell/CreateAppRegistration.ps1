...
Function global:CreateAppRegistration
{
    ...
    if (($AdApplication.DisplayName.Length).Equals(0))
    {
        ...
        if ($AppName -match 'api')
        {
            ...
            $AppRoles += $newAppRole
            Write-Host -ForegroundColor Green "CreateAppRegistration[34] newAppRole.DisplayName= " $newAppRole.DisplayName
            ...
            $AppRoles += $newAppRole
            Write-Host -ForegroundColor Green "CreateAppRegistration[43] newAppRole.DisplayName= " $newAppRole.DisplayName
            ...
            write-host -ForegroundColor Cyan "CreateAppRegistration[58] secret: $PlaintextSecretTest"
	...
	{
        Write-Host -ForegroundColor Red  -BackgroundColor Black "CreateAppRegistration[129] EXISTING app registration:" $AdApplication.DisplayName
    ...
    #Write-Host  -ForegroundColor Cyan  "CreateAppRegistration[156] $AppName json:"
    ##Write-Host $json    
