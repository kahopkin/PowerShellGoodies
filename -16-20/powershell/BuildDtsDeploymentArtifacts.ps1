...
param (
    ...
    [string[]] $Artifacts = @('OfflineFiles', 'Documentation', 'TransferApi', 'PickupApi', 'TransferUI', 'PickupUI'),
...
Function BuildArchive
{
    ...
    If($debugFlag){
        Write-host -ForegroundColor Magenta "BuildDtsDeploymentArtifacts.BuildArchive[104]::"
...
$dtpApiSlnRoot = Join-Path -Path $DTSSourceRoot -ChildPath "./Api/DPP"
...
if ($CompressOutput) {
    ...
    {
        Write-host -ForegroundColor Red  "[330] Test(archivePath)=" (Test-Path $archivePath)
    }
