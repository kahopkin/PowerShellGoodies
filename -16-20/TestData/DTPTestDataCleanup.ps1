...
<#
    ...
    .PARAMETER ResourceGroupName
        The Resource Group for the storage accounts.
    ...
    .EXAMPLE
        ...
        $auditStorageAccountName = Read-Host "Enter the Audit Storage Account Name: "
        $completedContainerName = Read-Host "Enter the Completed Container Name: "
        ...
        ResetDTPData -SubscriptionId $subscriptionId `
...
<#
    Read Me:
    1. You will be prompted for the values below.
        I.E.
    ...
    2. Specify the name(s) of the roledifinitions that should be removed inline below.
        I.E.
            $roleDefinitionNames = @(
                'DTP Storage Blob Data ReadWrite'
                'Storage Blob Data Contributor'
...
$auditStorageAccountName = Read-Host "Enter the Audit Storage Account Name: "
$completedContainerName = Read-Host "Enter the Completed Container Name: "
$confirmation = Read-Host "This script will delete/reset the DTP data in the Resource Group '$resourceGroupName', Storage Account '$storageAccountName', and Storage Account '$auditStorageAccountName'. Are you sure? [Y/N]"
