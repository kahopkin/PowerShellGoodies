...
Function global:RunDeployment 
{
	...
	"================================================================================"	>> $DeployInfo.LogFile
	"Step" + $DeployInfo.StepCount + ": RUN APP REGISTRATION: " + $AppName			>> $DeployInfo.LogFile
	"================================================================================"	>> $DeployInfo.LogFile
	...
	If($debugFlag)
	{
		Write-Host -ForegroundColor Magenta "RunDeployment.RunDeployment[30] "

		Write-Host -ForegroundColor DarkYellow "DeployObject.APIAppRegName=" $DeployObject.APIAppRegName
		Write-Host -ForegroundColor DarkYellow "DeployObject.APIAppRegExists=" $DeployObject.APIAppRegExists
		Write-Host -ForegroundColor DarkYellow "DeployObject.ClientAppRegName=" $DeployObject.ClientAppRegName
			Write-Host -ForegroundColor DarkYellow "DeployObject.ClientAppRegExists=" $DeployObject.ClientAppRegExists
		Write-Host -ForegroundColor DarkYellow "DeployObject.Solution=" $DeployObject.Solution
	...
	{
		$DeployObject = CreateAppRegistration -AppName $DeployObject.APIAppRegName -DeployObject $DeployObject
	...
	{
		$DeployObject = CreateAppRegistration -AppName $DeployObject.ClientAppRegName -DeployObject $DeployObject 
	}
	<#else
	{
