...
Function global:CreateDeployInfo
{
    ...
    if (Test-Path ($DeployInfo.OutFileJSON)) 
    {
        ...
        <#$global:TransferAppObj = [ordered]@{
            ...
            EndTime = "EndTime";
		    Duration = "Duration";
            #StartTime = $json.TransferAppObj.StartTime;
            #EndTime = $json.TransferAppObj.EndTime;
...
Function global:ConfigureDeployInfo
{
    ...
    If($debugFlag)
    {
        Write-Host -ForegroundColor Magenta "InitiateScripts.ConfigureDeployInfo[587]"                
...
Function global:ConfigureTransferAppObj
{
    ...
    Write-Debug "InitiateScripts.ConfigureTransferAppObj[628]"
    <#    
    If($debugFlag)
    {
        Write-Host -ForegroundColor Magenta "InitiateScripts.ConfigureTransferAppObj[636]"
        Write-Host -ForegroundColor Magenta "InitiateScripts.ConfigureTransferAppObj[637] SqlAdmin=" $SqlAdmin
    ...
    { 
        ...
        #$TransferAppObj.SqlAdminPwd = Read-Host "Enter SQL Server Admin Password" #-AsSecureString
        #ConvertFrom-SecureString-AsPlainText -SecureString $SqlAdminPwdSecure
        #$TransferAppObj.SqlAdminPwd = ConvertFrom-SecureString -SecureString $SqlAdminPwdSecure
        #Write-Host -ForegroundColor Yellow "InitiateScripts.ConfigureTransferAppObj[697] TransferAppObj.SqlAdminPwd:" $TransferAppObj.SqlAdminPwd
        <#
        $SqlAdminPwdSecure = 
        
        $SqlAdminPwdSecure = Read-Host "Enter SQL Server Admin Password" -AsSecureString         
        $SecureStringAsPlainText = $SqlAdminPwdSecure | ConvertFrom-SecureString
        $SqlAdminPwd =  ConvertFrom-SecureString-AsPlainText -SecureString $SecureStringAsPlainText

        $bstr = [System.Runtime.InteropServices.Marshal]::SecureStringToBSTR($SecureStringAsPlainText);
        #$PlainTextString = [System.Runtime.InteropServices.Marshal]::PtrToStringAuto($bstr);
        #$SqlAdminPwdText = ConvertFrom-SecureString-AsPlainText -SecureString $SqlAdminPwd
        #$DeployInfo.SqlAdminPwd = $SqlAdminPwd
        #$DeployInfo.TransferAppObj.SqlAdminPwd = $SecureStringAsPlainText
        #$DeployInfo.TransferAppObj.SqlAdminPwd = $PlainTextString
        #$DeployInfo.SqlAdminPwd = ConvertTo-SecureString $SqlAdminPwd -AsPlainText -Force
        #$DeployInfo.TransferAppObj.SqlAdminPwd = ConvertTo-SecureString $SqlAdminPwd -AsPlainText -Force        
    ...
    Else
    {
        ...
        #$SqlAdminPwd = ConvertFrom-SecureString-AsPlainText -SecureString $SqlAdminPwd
        #$DeployInfo.SqlAdminPwd = $SqlAdminPwd
        $DeployInfo.TransferAppObj.SqlAdminPwd = $SqlAdminPwd
        #$DeployInfo.SqlAdminPwd = ConvertTo-SecureString $SqlAdminPwd -AsPlainText -Force
        #$DeployInfo.TransferAppObj.SqlAdminPwd = ConvertTo-SecureString $SqlAdminPwd -AsPlainText -Force
...
Function global:ConfigurePickupAppObj
{
    ...
    <#If($debugFlag)
    {
        Write-Host -ForegroundColor Magenta "InitiateScripts.ConfigurePickupAppObj[631]"
        Write-Host -ForegroundColor Green "InitiateScripts.ConfigurePickupAppObj[634] DeployMode:" $DeployInfo.DeployMode
    }#>
