...
Function global:AddAPIPermissions{
 Param(      
    ...
    Write-Host -ForegroundColor Yellow "AddAPIPermissions[17] PermissionParent:" $PermissionParent
   <#
    #DEBUG	
    $i=0
   ...
   #>
    ...
    {
        Write-Host -ForegroundColor Yellow "AddAPIPermissions[32] PermissionParent:" $PermissionParent
        $GraphId = (Get-AzADServicePrincipal -DisplayName "$PermissionParent").AppId
        Write-Host -ForegroundColor Yellow "AddAPIPermissions[34] GraphId:" $GraphId
        
        $GraphSPN = Get-MgServicePrincipal -Filter "AppId eq '$GraphId'"
        Write-Host -ForegroundColor Yellow "AddAPIPermissions[37] GraphSPN.Id:" $GraphSPN.Id
    ...
    Write-Host -ForegroundColor Yellow "AddAPIPermissions[65] RequiredPermissions.ResourceAccess"
