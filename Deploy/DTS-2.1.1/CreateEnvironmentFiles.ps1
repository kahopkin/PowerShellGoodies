Function global:CreateEnvironmentFiles
{
	...
	Write-Host -ForegroundColor Cyan "Step" $DeployInfo.StepCount ": CREATE .ENV FILES:" 
	Write-Host -ForegroundColor Cyan "================================================================================"
	...
	$DPPEnvObject = [ordered]@{
		...
		REACT_APP_AAD_AUTHORITY = $DeployInfo.Cloud.ActiveDirectoryAuthority + $DeployInfo.TenantId;
