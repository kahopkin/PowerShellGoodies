...
Function DeleteTestContainers
{
    ...
    Write-Host -ForegroundColor Magenta  -BackgroundColor Black "`n *************[$today] START DeleteTestContainers FOR $ResourceGroupName *****************"
    ...
    $today = Get-Date -Format 'MM-dd-yyyy-HH-mm:ss'
    Write-Host -ForegroundColor Magenta  -BackgroundColor Black "`n *************[$today] FINISHED DeleteTestContainers FOR $ResourceGroupName *****************"
     
}#function


$ResourceGroupName = "rg-satsite-dev"
$StorageAccountName = "stsatsitedev00"
$Prefix = "cpf"
