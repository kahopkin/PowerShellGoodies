...
var environmentType = split(SolutionName,'-')[2]
var alwaysOn = false
...
resource webapp_privateEndpoint 'Microsoft.Network/privateEndpoints@2020-03-01' = if(environmentType == 'prod') {
...
resource webapp_privateDNSZoneVirutalNetworkLink 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2018-09-01' =  if(environmentType == 'prod'){
  parent: webapp_privateDNSZone
...
resource webapp_privateEndpoint_privateDnsZoneGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2020-03-01' =  if(environmentType == 'prod'){
