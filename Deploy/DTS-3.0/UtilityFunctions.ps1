...
Function global:PickDeployMethod
{
	...
	#
	If($debugFlag){
		Write-Host -ForegroundColor DarkBlue -BackgroundColor White "UtilityFunctions.PickDeployMethod[155] "
...
Function global:ParseInputFile
{
	...
	If($debugFlag){
		$today = Get-Date -Format "MM/dd/yyyy HH:mm:ss"
		Write-Host -ForegroundColor DarkBlue -BackgroundColor White "`n[$today] STARTING UtilityFunctions.ParseInputFile[291]"
	...
	If($DeployObject.DebugFlag){
		$Caller ='UtilityFunctions.ParseInputFile[325]:: After parsing deploy param file'
		$ObjectName = "DeployObject"
		PrintCustomObject -ObjectName $ObjectName -Object $DeployObject -Caller $Caller
	}#If($debugFlag)#>
}#ParseInputFile
...
Function global:PickCodeEnvironment
{
	...
	If($debugFlag){
		$today = Get-Date -Format "MM/dd/yyyy HH:mm:ss"
		Write-Host -ForegroundColor DarkBlue -BackgroundColor White "`n[$today] STARTING UtilityFunctions.PickCodeEnvironment[1080]"
	}#If($debugFlag)#>
...
Function global:SetConfigObj
{
	...
	If($debugFlag){
		$today = Get-Date -Format "MM/dd/yyyy HH:mm:ss"
		Write-Host -ForegroundColor DarkBlue -BackgroundColor White "`n[$today] STARTING UtilityFunctions.SetConfigObj[1459]"
		<#
...
Function global:CreateComponentHash
{
	...
	{
		$today = Get-Date -Format "MM/dd/yyyy HH:mm:ss"
		$Caller = "`n[" + $today + "] STARTING UtilityFunctions.CreateComponentHash[1618]"
		Write-Host -ForegroundColor DarkBlue -BackgroundColor White $Caller
		Write-Host -ForegroundColor White "`$ObjectName= " -NoNewline
		Write-Host -ForegroundColor Cyan "`"$ObjectName`""
		PrintCustomObjectAsObject -Object $ConfigObject -Caller $Caller -ObjectName $ObjectName
...
Function global:ParseDeploymentOutput
{
	...
	If($debugFlag){
		$today = Get-Date -Format "MM/dd/yyyy HH:mm:ss"
		$Caller = "`n[$today] STARTING UtilityFunctions.ParseDeploymentOutput[1419]"
		Write-Host -ForegroundColor DarkBlue -BackgroundColor White $Caller
	}#If($debugFlag)#>
...
Function global:ConfigureStorageEncryption
{
	...
	If($debugFlag){
		$today = Get-Date -Format "MM/dd/yyyy HH:mm:ss"
		Write-Host -ForegroundColor DarkBlue -BackgroundColor White "`n[$today] STARTING UtilityFunctions.ConfigureStorageEncryption[1750]"
	}#If($debugFlag)#>
	...
	If($debugFlag)
	{
		Write-Host -ForegroundColor DarkBlue -BackgroundColor White "`n UtilityFunctions.ConfigureStorageEncryption[1762]"
	...
	If($StorageAccount -match 'audit')
	{
		...
		#
		If($debugFlag){
			Write-Host -ForegroundColor Magenta "UtilityFunctions.ConfigureStorageEncryption[1780]:"
	...
	Else
	{
		...
		#
		If($debugFlag){
			Write-Host -ForegroundColor Magenta "UtilityFunctions.ConfigureStorageEncryption[1792]:"
	...
	$psCommand = "`$stAccount = `n`tSet-AzStorageAccount  ```n`t`t" +
						...
						"-AssignIdentity`n"
	If($PrintPSCommands){
		Write-Host -ForegroundColor Magenta "UtilityFunctions.ConfigureStorageEncryption[1809]:"
		Write-Host -ForegroundColor Green $psCommand
	}#If($PrintPSCommands) #>
	########################################################################################
	...
	If($PrintPSCommands){
		Write-Host -ForegroundColor Magenta "UtilityFunctions.ConfigureStorageEncryption[1823]:"
		Write-Host -ForegroundColor Green $psCommand
	}#If($PrintPSCommands) #>
	...
	#
	If($debugFlag){
		Write-Host -ForegroundColor Magenta "UtilityFunctions.ConfigureStorageEncryption[1832]:"
	...
	#
	If($PrintPSCommands){
		Write-Host -ForegroundColor Magenta "UtilityFunctions.ConfigureStorageEncryption[1861]:"
		Write-Host -ForegroundColor Green $psCommand
	...
	If($debugFlag){
		Write-Host -ForegroundColor Magenta "UtilityFunctions.ConfigureStorageEncryption[1880]"
		Write-Host -ForegroundColor Green "Assign the KV Crypto Service Encryption User role to :"$SystemPrincipalName
		Write-Host -ForegroundColor DarkBlue -BackgroundColor White "UtilityFunctions.ConfigureStorageEncryption[1882]:: Calling AddRoleAssignment..."
	...
	$psCommand = "AddRoleAssignment  ```n`t`t" +
	...
	#
	If($debugFlag){
		Write-Host -ForegroundColor Magenta "UtilityFunctions.ConfigureStorageEncryption[1900]:"
	...
	#
	If($debugFlag){
		Write-Host -ForegroundColor Magenta "UtilityFunctions.ConfigureStorageEncryption[1918]"
	...
	#
	If($PrintPSCommands){
		Write-Host -ForegroundColor Magenta "UtilityFunctions.ConfigureStorageEncryption[1945]:"
		Write-Host -ForegroundColor Green $psCommand
		For($i=1;$i -le 80;$i++){If($i -eq 80){Write-Host -ForegroundColor Green -BackgroundColor Black "=" } Else{ Write-Host -ForegroundColor Green -BackgroundColor Black "=" -NoNewline}}
	}#If($PrintPSCommands) #>
	########################################################################################
...
Function global:AddKeyVaultAccessPolicy
{
	...
	If($debugFlag){
		$today = Get-Date -Format "MM/dd/yyyy HH:mm:ss"
		Write-Host -ForegroundColor DarkBlue -BackgroundColor White "`n[$today] STARTING UtilityFunctions.AddKeyVaultAccessPolicy[1961]" 
	...
	$psCommand =
		...
		If($PrintPSCommands){
		Write-Host -ForegroundColor Magenta "UtilityFunctions.AddKeyVaultAccessPolicy[1978] - azRequestString:"
		Write-Host -ForegroundColor Green $psCommand
		}#If($PrintPSCommands) #>
...
Function global:CheckAllAzResources
{
	...
	ForEach ($resource in $AzResourcesComplexObj.GetEnumerator())
	{
		...
		$DeployObjectPropExists = $key + "Exists"
		$ObjectResourceId = $key + "ResourceId"
		Write-Host -ForegroundColor Yellow "`$DeployObjectPropExists= " -NoNewline
		Write-Host -ForegroundColor Green "`"$DeployObjectPropExists`""

		$DeployObject.$DeployObjectPropExists =
...
Function global:CheckForExistingResource
{
	...
	{
		$today = Get-Date -Format "MM/dd/yyyy HH:mm:ss"
		$Caller = "`n[" + $today + "] STARTING UtilityFunctions.CheckForExistingResource[2167]"
		Write-Host -ForegroundColor DarkBlue -BackgroundColor White $Caller
	...
	If($ResourceName.length -eq 0)
	{
		...
		#Write-Host -ForegroundColor Yellow "UtilityFunctions.CheckForExistingResource[2192] $ResourceName.length=0"
	}#If($ResourceName.length -eq 0)
	Else
	{
		$Caller = "`n UtilityFunctions.CheckForExistingResource[2196]" + "`$ResourceName= `"" + $ResourceName+ "`""
		...
		#
		If($PrintPSCommands){
			#Write-Host -ForegroundColor Magenta "UtilityFunctions.CheckForExistingResource[2210]:"
			Write-Host -ForegroundColor Green $psCommand
		}#If($PrintPSCommands) #>
		...
		Else
		{
			...
			$Caller = "`n UtilityFunctions.CheckForExistingResource[2222] resourceExists=TRUE"
			#Write-Host -ForegroundColor DarkBlue -BackgroundColor White $Caller
			...
			Switch($myResourceType)
			{
				"Network"
				{
					$Caller = "UtilityFunctions.CheckForExistingResource[2231] myResourceType -eq " + $myResourceType
					#Write-Host -ForegroundColor DarkBlue -BackgroundColor White $Caller
					#Write-Host -ForegroundColor Magenta "Network `n`$myResourceType= `"$myResourceType`""
				}#Network
				"ManagedIdentity"
				{
					$Caller = "UtilityFunctions.CheckForExistingResource[2237] myResourceType -eq " + $myResourceType
				...
				"KeyVault"
				{
					$Caller = "UtilityFunctions.CheckForExistingResource[2244] myResourceType -eq " + $myResourceType
					#Write-Host -ForegroundColor DarkCyan -BackgroundColor White $Caller
					...
					If($debugFlag)
					{
						$Caller = "UtilityFunctions.CheckForExistingResource[2253] myResourceType -eq " + $myResourceType
						Write-Host -ForegroundColor DarkCyan -BackgroundColor White $Caller
						Write-Host -ForegroundColor Magenta -BackgroundColor White "UtilityFunctions.CheckForExistingResource[2255]"
				...
				"Web"
				{
					$Caller = "UtilityFunctions.CheckForExistingResource[2262] myResourceType -eq " + $myResourceType
					#Write-Host -ForegroundColor DarkCyan -BackgroundColor White $Caller
					...
					#
					If($debugFlag){
							$Caller = "UtilityFunctions.CheckForExistingResource[2269] myResourceType -eq " + $myResourceType
							Write-Host -ForegroundColor DarkCyan -BackgroundColor White $Caller
				...
				"Storage"
				{
					$Caller = "UtilityFunctions.CheckForExistingResource[2276] myResourceType -eq " + $myResourceType
					...
					#
					If($debugFlag){
						$Caller = "UtilityFunctions.CheckForExistingResource[2283] myResourceType -eq " + $myResourceType + "`n Calling ConfigureStorageEncryption"
						Write-Host -ForegroundColor DarkCyan -BackgroundColor White $Caller
				...
				"Sql"
				{
					$Caller = "UtilityFunctions.CheckForExistingResource[2293] myResourceType -eq " + $myResourceType
				...
				Default
				{
					$Caller = "UtilityFunctions.CheckForExistingResource[2301] myResourceType -eq " + $myResourceType
