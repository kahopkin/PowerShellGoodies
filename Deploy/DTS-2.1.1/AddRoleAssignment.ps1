...
Function global:AddCustomRoleFromFile
{
	...
	If($debugFlag){
		Write-Host -ForegroundColor Magenta "AddCustomRoleFromFile[32]"
...
Function global:AddRoleAssignment
{
	...
	If($debugFlag){
		...
		Write-Host -ForegroundColor Yellow "`$UserId=`"$UserId`""
	}#>
...
Function global:AddUsersToUserGroup
{
	...
	Write-Debug "AddRoleAssignment.AddUsersToUserGroup[169]"
	<#If($debugFlag){
		Write-Host -ForegroundColor Magenta "AddRoleAssignment.AddUsersToUserGroup[142] "
	}#>

	$today = Get-Date -Format "MM/dd/yyyy HH:mm:ss" 

	"================================================================================"									>> $DeployInfo.LogFile
	"Step" + $DeployInfo.StepCount + ": ADD INTERNAL TENANT USERS TO : " + $UserGroup									>> $DeployInfo.LogFile
	"================================================================================"									>> $DeployInfo.LogFile

	Write-Host -ForegroundColor Yellow "================================================================================"
	Write-Host -ForegroundColor Yellow "Step" $DeployInfo.StepCount":  ADD INTERNAL TENANT USERS TO : " $UserGroup
	Write-Host -ForegroundColor Yellow "================================================================================"
	$DeployInfo.StepCount++
