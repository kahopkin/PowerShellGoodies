    ...
    if (Test-Path $ParentFolder) 
    {
        ...
        { 
            ...
            if($Extension -eq ".zip")
            {
                ...
                {
                    Write-Host -ForegroundColor Cyan "[87] NewFolderPath=$NewFolderPath "
                }
                ...
                {
                    Expand-Archive -LiteralPath $FullPath -DestinationPath $NewFolderPath -Force
...
#$ParentFolder = 'C:\GitHub\dtpResources\rg-depguide-prod'

#$ParentFolder = 'C:\GitHub\dtpResources\rg-datadrop-prod'
$ParentFolder = "C:\Users\deployadmin\Downloads"
ExtractZips -ParentFolder $ParentFolder 