...
//var  sasToken = storageAccounts.outputs.sasToken
//var connectionStringSAS = storageAccounts.outputs.connectionStringSAS
//output connectionStringSASOut string = connectionStringSAS
